...
- **标题**: {session_data.get('title', 'N/A')}
- **创建时间**: {session_data.get('created_at', 'N/A')}
- **项目阶段**: {session_data.get('current_stage', 'N/A')}
- **消息数量**: {len(session_data.get('messages', []))}
- **工具执行数**: {len(session_data.get('tool_history', []))}
        """
